...
class CashCardJsonTest {
    ...
    void setUp(){
        cashCards = Arrays.array(
                ...
                new CashCard(102L,1425.00, "sarah1"),
                new CashCard(103L,150.00, "sarah1"),
                new CashCard(104L,134.00, "sarah1"),
                new CashCard(105L,50.00, "sarah1")
        );
    }
    ...
    void cashCardListSerializationTest() throws IOException{
        assertThat(jsonList.write(cashCards)).isStrictlyEqualToJson("cashCardList.json");
    }
    ...
    void cashCardListDeserializationTest() throws IOException{
        String expected= """
                [
                  ...
                  {"id": 102, "amount": 1425.00, "owner": "sarah1" },
                  {"id": 103, "amount": 150.00, "owner": "sarah1" },
                  {"id": 104, "amount": 134.00 , "owner": "sarah1"},
                  {"id": 105, "amount": 50.00 , "owner": "sarah1"}
                ]
